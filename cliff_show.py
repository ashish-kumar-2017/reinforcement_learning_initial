...
def initialize_frame():
    ...
    # Goal
    frame1 = cv2.putText(img, text="G", org=(49 * 11 + margin_horizontal + 10, 49 * 4 + margin_vertical - 10),
...
def put_agent(img, state1):
    margin_horizontal = 6
    margin_vertical = 2
    row, column = np.unravel_index(indices=state1, shape=(4, 12))
